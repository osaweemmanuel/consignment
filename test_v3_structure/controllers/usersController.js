...
const register = asyncHandler(async (req, res) => {
  const { firstname, lastname, gender, email, password, adminKey } = req.body;

  // Validate Secret Access Key
  if (adminKey !== (process.env.ADMIN_REGISTRATION_KEY || 'TUNSHPRESH_GLOBAL_ADMIN_AUTH')) {
    res.status(403);
    throw new Error("Unauthorized: Invalid Global Admin Access Key.");
  }
